      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="mx-auto nav-links d-flex flex-row justify-content-center align-items-center gap-3">
            <Nav.Link as={Link} spy={true} to="skills" smooth={true} duration={60} offset={54}>
              Skills
            </Nav.Link>
            <Nav.Link as={Link} spy={true} to="cards-collection" smooth={true} duration={60} offset={-60}>
              My Card
            </Nav.Link>
            <Nav.Link as={Link} spy={true} to="projects" smooth={true} duration={60} offset={42}>
              Projects
            </Nav.Link>
          </Nav>
          <Music />
